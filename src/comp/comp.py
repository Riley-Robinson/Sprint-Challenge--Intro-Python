...
startsctog = ["C", "D", "E", "F", "G"]
c = [human.name for human in humans if human.name[0] in startsctog]
print(c)
...
g = [Human(human.name.upper(), humane.age + 5) for human in humans]
print(g)
